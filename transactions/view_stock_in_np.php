...
<html>
    ...
    <?php
        $sql="Select trans_dt,trans_cd,do_no,prod_desc,trans_type,
        qty_bags_tin,qty_cs,qty_kg,qty_pieces,created_by,created_dt from td_stock_trans_np
	      where approval_status='U' AND trans_type= 'I' order by trans_cd";
                ...
                <div class="col-lg-8 col-md-6">
                    ...
                    <div class="container-contact1">
                        ...
                        <div class="contact1-form">
                            ...
                            Approve NON PDS Stock In Transactions
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="../edit/edit_np_stock_in.php?trans_dt=<?php echo $trans_dt;?>&trans_cd=<?php echo $trans_cd; ?>"
                                            style="color: black;">
                                                <i class="fa fa-edit fa-2x" style="color: #006eff"></i> Edit</a>

                                            <a href="../approve/aprv_np_stock_in.php?trans_dt=<?php echo $trans_dt;?>&trans_cd=<?php echo $trans_cd; ?>"
