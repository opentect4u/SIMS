<?php
   ...
   // require_once("../post/sims_function.php");
	...
	if ($_SERVER["REQUEST_METHOD"]=="POST"){
      ...
      /*  $prod_cd = f_getprodcd($prod_desc,$db_connect);
        $catg_cd = f_getcatgcd($prodcatg,$db_connect);
        $qty_bal = f_getallotbal($allot_no, $prod_cd,$db_connect);
        $tot_bal = f_getquintal($qty_bags_tin,$qty_cs,$qty_kg,$qty_pieces,$db_connect);
        ...
        if(array_sum(array($qty_bags_tin, $qty_cs, $qty_kg, $qty_pieces)) > 0 && !is_null($allot_no)) {
            ...
            $sql="insert into td_stock_trans_np (trans_dt,
                                ...
                                header("Location: view_stock_out_np.php");
    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                var    allot_no         =    $('.validate-input input[name = "do_no"]');
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="container-contact1">
                        ...
                        <form class="contact1-form validate-form" id="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                                ...
                                <div class="wrap-input1 validate-input" data-validate="Allotment No. is required" data-alert="Do No.">

                                    <input type="text" class="input1" name="allot_no" id="allot_no" placeholder="Allotment Number" />
                                ...
                                <div class="wrap-input1 validate-input" data-alert="Product's Serial No.">
                                    ...
                                    <input type="text" class="input1" name="prod_sl_no" id="sl_no" readonly />
                                ...
                                <div class="wrap-input1 validate-input" data-alert="Bag/Tin" >
                                    ...
                                    <input type="text" class="input1" name="qty_bags_tin" value="0.00" placeholder="Bag" />
